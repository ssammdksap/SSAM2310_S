...
export default function FilterOnLoaded(pageClientAPI) {
    try {
        ...
        if (prevPage.actionResults && prevPage.actionResults.filterResult && prevPage.actionResults.filterResult.data && prevPage.actionResults.filterResult.data.filter.includes('islocal')) {
