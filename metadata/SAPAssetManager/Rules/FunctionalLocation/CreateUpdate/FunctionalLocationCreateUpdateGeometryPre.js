...
export default function FunctionalLocationCreateUpdateGeometryPre(context) {
    ...
    if (context.getPageProxy().currentPage.id !== 'FunctionalLocationMapCreatePage' &&
        context.getPageProxy().currentPage.id !== 'FunctionalLocationMapUpdatePage' &&
        context.getPageProxy().currentPage.id !== 'FunctionalLocationCreateUpdatePage') {
