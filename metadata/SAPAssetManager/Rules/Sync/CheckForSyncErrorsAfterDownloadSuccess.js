                        ...
                        return readUserFeatures(context).then(() => {
                            return FetchAndSaveMetadataDuringSync(context).then(() => {
                                return CreateDefaultOverviewRowEntities(context).then(() => {
                                    ...
                                    if (context.getPageProxy()._page && context.getPageProxy()._page._definition && ((context.getPageProxy()._page._definition.name && context.getPageProxy()._page._definition.name !== 'CreateUpdatePage') || (context.getPageProxy()._page._definition.getName() && context.getPageProxy()._page._definition.getName() !== 'CreateUpdatePage'))) {
