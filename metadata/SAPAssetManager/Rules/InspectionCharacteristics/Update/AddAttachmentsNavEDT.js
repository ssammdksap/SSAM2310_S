...
export default async function AddAttachmentsNavEDT(context) {
    ...
    var page = context.getPageProxy().getPageDefinition('/SAPAssetManager/Pages/InspectionCharacteristics/Update/InspectionCharacteristicsAddEditAttachments.page');
