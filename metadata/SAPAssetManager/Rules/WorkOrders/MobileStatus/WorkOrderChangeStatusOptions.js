...
export default function WorkOrderChangeStatusOptions(context) {
    ...
    const binding = context.getPageProxy().getActionBinding() ? context.getPageProxy().getActionBinding() : context.binding;
                        ...
                        codes.forEach(element => {
                            ...
                            if (statusElement) {
                                ...
                                if (statusElement.MobileStatus === APPROVE && element.RoleType === userRoleType) {
                                    ...
                                    popoverItems.push({'Status': statusElement.MobileStatus, 'Title': transitionText, 'OnPress': mobileStatusOverride(context, statusElement, 'OrderMobileStatus_Nav', postUpdateRule), 'TransitionType': transitionType});
                                    ...
                                    if (!(statusElement.MobileStatus === STARTED && anythingStarted)
                                        ...
                                        popoverItems.push({'Status': statusElement.MobileStatus, 'Title': transitionText, 'OnPress': mobileStatusOverride(context, statusElement, 'OrderMobileStatus_Nav', '/SAPAssetManager/Rules/MobileStatus/WorkOrderMobileStatusPostUpdate.js'), 'TransitionType': transitionType});
                                    }
                                    ...
                                    if ((statusElement.MobileStatus === APPROVE || statusElement.MobileStatus === DISAPPROVE)
                                        && PhaseLibrary.supervisorStatusChangeAllowed(context, element) && isPhaseModelActiveInDataObject) {
                                            popoverItems.push({'Status': statusElement.MobileStatus, 'Title': transitionText, 'OnPress': mobileStatusOverride(context, statusElement, 'OrderMobileStatus_Nav'), 'TransitionType': transitionType});
                                        }
                                }
                            }
