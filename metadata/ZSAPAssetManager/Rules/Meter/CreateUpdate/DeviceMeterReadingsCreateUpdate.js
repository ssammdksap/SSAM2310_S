...
import MeterReplaceInstall from '../../../../SAPAssetManager/Rules/Meter/CreateUpdate/MeterReplaceInstall';
...
export default function DeviceMeterReadingsCreateUpdate(context) {
    ...
    sectionHelper.run((sectionBinding, section) => {
        ...
        let ZPriviousReading = libCommon.getStateVariable(context, 'ZPreviousMeterReading');
        let OrderType = libCommon.getStateVariable(context, 'SerialNumOrderType');
        ...
        let decimalCount = sectionBinding.DecimalBefore;
        const resultStr = '9'.repeat(decimalCount);
