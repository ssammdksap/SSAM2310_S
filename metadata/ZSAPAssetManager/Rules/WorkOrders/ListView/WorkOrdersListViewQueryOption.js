...
export default function WorkOrdersListViewQueryOption(context) {
    ...
    if (searchString) {
        ...
        // SEWA Search  
        filters.push(`substringof('${searchString}', tolower(Address/ZConsumerNumber))`);
        filters.push(`substringof('${searchString}', tolower(Address/ZSEWAAreaCode))`);
        filters.push(`substringof('${searchString}', tolower(Address/Building))`);
        filters.push(`substringof('${searchString}', tolower(Address/ZPlotNo))`);
        filters.push(`substringof('${searchString}', tolower(Address/HouseNum))`);
        

        filters.push(`substringof('${searchString}', tolower(FunctionalLocation/Address/ZConsumerNumber))`);
        filters.push(`substringof('${searchString}', tolower(FunctionalLocation/Address/ZSEWAAreaCode))`);
        filters.push(`substringof('${searchString}', tolower(FunctionalLocation/Address/Building))`);
        filters.push(`substringof('${searchString}', tolower(FunctionalLocation/Address/ZPlotNo))`);
