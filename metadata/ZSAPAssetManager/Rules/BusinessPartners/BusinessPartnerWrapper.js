...
export class BusinessPartnerWrapper {
    ...
    addressProperty(property) {
        ...
        let propertyMap = {
            ...
            'Floor': 'Floor',
            'Room': 'RoomNum',
            'ConsumerNumber': 'ZConsumerNumber',
            'XCordinates': 'ZXCordinates',
            'YCordinates': 'ZYCordinates',
            'SEWAAreaCode': 'ZSEWAAreaCode',
            ...
            switch (this.partnerType) {
                ...
                case 'KU': //For vendor and customer, the address info is in the 
                    propertyMap = {
                        ...
                        'PersonNum': 'PersonNum',
                        'ConsumerNumber': 'ZConsumerNumber',
                        'XCordinates': 'ZXCoordinates',
                        'YCordinates': 'ZYCoordinate',
                        'SEWAAreaCode': 'ZSEWAAreaCode',
                    };
                    break;
                case 'AP':
